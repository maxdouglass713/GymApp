    ...
    <Modal visible={visible} animationType="slide" transparent>
      <View style={styles.modalOverlay}>
        <View style={[styles.modalContent, { backgroundColor: BrandColors.background }]}>
          <Text style={[styles.modalTitle, { color: BrandColors.text }]}>Workout Review</Text>
          <Text style={[styles.modalText, { color: BrandColors.textSecondary }]}>
            Review your workout performance and get personalized recommendations.
          </Text>
          <TouchableOpacity
            style={[ComponentStyles.button.primary, styles.modalButton]}
            onPress={onReview}
          >
            <Text style={[ComponentStyles.button.primaryText, { color: '#000' }]}>Review Workout</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={[ComponentStyles.button.secondary, styles.modalButton]}
            onPress={onClose}
          >
            <Text style={[ComponentStyles.button.secondaryText, { color: BrandColors.text }]}>Skip</Text>
          </TouchableOpacity>
        </View>
      </View>
    </Modal>
