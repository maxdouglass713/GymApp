  ...
  try {
    if (userInput === "y") {
      ...
      if (!fs.existsSync(exampleDirPath)) {
        ...
        console.log(`📁 /${exampleDir} directory already exists.`);
      }
    }
      ...
      if (fs.existsSync(oldDirPath)) {
        try {
          if (userInput === "y") {
            ...
            // Check if destination already exists and remove it first
          ...
          console.error(`❌ Error processing /${dir}: ${dirError.message}`);
        }
      } else {
